...
process WORKSPACE {
    ...
    cp *.mzML *.fasta ${params.workspace}/../data/small_peptides
    """
...
process GENERATEPARAMS {
    ...
    publishDir "${params.philosopher_outDir}/generateparams", mode: 'copy'
...
process MSFRAGGER {
    ...
    if( params.fragger_mode == "local" )
        ...
        cd ${params.workspace}
        java -Xmx${params.fragger_ram}g -jar ${params.workspace}/../data/MSFragger/MSFragger.jar ${closed_fragger} ${mzML_file} 2> msfragger.out
